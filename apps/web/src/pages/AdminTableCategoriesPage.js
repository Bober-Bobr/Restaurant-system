...
export const AdminTableCategoriesPage = () => {
    ...
    return (_jsxs("main", { style: { padding: 20 }, children: [_jsx("h1", { children: t('table_categories_management') }), _jsxs("section", { style: { border: '1px solid #ddd', borderRadius: 8, padding: 12, marginBottom: 16 }, children: [_jsx("h3", { children: t('create_table_category') }), _jsxs("form", { onSubmit: (event) => {
                            ...
                            createMutation.mutate();
                                ...
                                alignItems: 'center'
                            }, children: editingId === category.id ? (_jsxs("div", { style: { flex: 1 }, children: [_jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr 1fr auto', gap: 8, alignItems: 'end', marginBottom: 12 }, children: [_jsxs("label", { style: { display: 'grid', gap: 4 }, children: [t('name'), _jsx(Input, { value: editName, onChange: (e) => setEditName(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: [t('capacity'), _jsx(Input, { type: "number", min: 1, max: 1000, value: editSeatingCapacityText, onChange: (e) => setEditSeatingCapacityText(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: [t('meal_package'), _jsx(Input, { value: editMealPackage, onChange: (e) => setEditMealPackage(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: [t('rate_dollar'), _jsx(Input, { value: editRatePerPersonText, onChange: (e) => setEditRatePerPersonText(e.target.value) })] })] }), _jsx("div", { style: { marginBottom: 12 }, children: _jsxs("label", { style: { display: 'grid', gap: 4 }, children: [t('description'), _jsx(Input, { value: editDescription, onChange: (e) => setEditDescription(e.target.value) })] }) }), _jsx("div", { style: { marginBottom: 12 }, children: _jsx(PhotoSelector, { category: "table", selectedPhotoUrl: editPhotoUrl || undefined, onPhotoSelect: (url) => setEditPhotoUrl(url || ''), placeholder: t('select_table_photo') }) }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: [t('active'), _jsx("input", { type: "checkbox", checked: editIsActive, onChange: (e) => setEditIsActive(e.target.checked) })] }), _jsxs("div", { style: { display: 'flex', gap: 4 }, children: [_jsx(Button, { onClick: saveEdit, disabled: !canSaveEdit, children: updateMutation.isPending ? t('saving') : t('save') }), _jsx(Button, { variant: "secondary", onClick: cancelEdit, children: t('cancel') })] }), editValidation.errors.length > 0 && (_jsx("div", { style: { gridColumn: '1 / -1', color: '#b00020', fontSize: '0.9em' }, children: editValidation.errors[0] }))] })) : (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: 'flex', gap: 8, alignItems: 'center' }, children: [category.photoUrl ? (_jsx("img", { src: getPhotoUrl(category.photoUrl), alt: category.name, style: { width: 80, height: 60, objectFit: 'cover', borderRadius: 4 } })) : null, _jsxs("div", { children: [_jsx("strong", { children: category.name }), _jsxs("p", { style: { margin: '4px 0 0', fontSize: '0.9em', color: '#666' }, children: [t('capacity'), ": ", category.seatingCapacity, ", ", t('meal'), ": ", category.mealPackage, ", ", t('rate'), ": $", (category.ratePerPerson / 100).toFixed(2), category.description ? ` - ${category.description}` : '', !category.isActive && ` (${t('inactive')})`] })] })] }), _jsxs("div", { style: { display: 'flex', gap: 4 }, children: [_jsx("button", { onClick: () => startEditing(category), style: { background: '#28a745', color: 'white', padding: '4px 8px', border: 'none', borderRadius: 4 }, children: t('edit') }), _jsx("button", { onClick: () => deleteMutation.mutate(category.id), disabled: deleteMutation.isPending, style: { background: '#b00020', color: 'white', padding: '4px 8px', border: 'none', borderRadius: 4 }, children: t('delete') })] })] })) }, category.id))) }))] }))] }));
};
