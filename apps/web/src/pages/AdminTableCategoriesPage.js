...
export const AdminTableCategoriesPage = () => {
    ...
    return (_jsxs("main", { style: { padding: 20 }, children: [_jsx("h1", { children: "Table Categories" }), _jsxs("section", { style: { border: '1px solid #ddd', borderRadius: 8, padding: 12, marginBottom: 16 }, children: [_jsx("h3", { children: "Create new table category" }), _jsxs("form", { onSubmit: (event) => {
                            event.preventDefault();
                            if (!canSubmit || createMutation.isPending)
                                return;
                            createMutation.mutate();
                        }, style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, alignItems: 'end' }, children: [_jsxs("label", { style: { display: 'grid', gap: 6 }, children: ["Name", _jsx("input", { value: name, onChange: (e) => setName(e.target.value), placeholder: "e.g., 2-person table" })] }), _jsxs("label", { style: { display: 'grid', gap: 6 }, children: ["Seating Capacity", _jsx("input", { type: "number", min: 1, max: 1000, inputMode: "numeric", value: seatingCapacityText, onChange: (e) => setSeatingCapacityText(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 6 }, children: ["Meal Package", _jsx("input", { value: mealPackage, onChange: (e) => setMealPackage(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 6 }, children: ["Rate Per Person (e.g. 10.00)", _jsx("input", { value: ratePerPersonText, onChange: (e) => setRatePerPersonText(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 6 }, children: ["Photo URL (Optional)", _jsx("input", { value: photoUrl, onChange: (e) => setPhotoUrl(e.target.value), placeholder: "https://example.com/image.jpg" })] }), _jsxs("label", { style: { display: 'grid', gap: 6, gridColumn: '1 / -1' }, children: ["Description (Optional)", _jsx("input", { value: description, onChange: (e) => setDescription(e.target.value) })] }), _jsxs("div", { style: { gridColumn: '1 / -1', display: 'flex', gap: 12, alignItems: 'center' }, children: [_jsx("button", { type: "submit", disabled: !canSubmit, children: createMutation.isPending ? 'Creating...' : 'Create category' }), validation.errors.length > 0 ? (_jsx("span", { style: { color: '#b00020' }, children: validation.errors[0] })) : null, createMutation.isError ? (_jsx("span", { style: { color: '#b00020' }, children: createMutation.error instanceof Error ? createMutation.error.message : 'Failed to create category.' })) : null] })] })] }), isLoading ? _jsx("p", { children: "Loading table categories..." }) : null, isError ? _jsx("p", { children: "Failed to load table categories." }) : null, categories && (_jsxs("section", { style: { border: '1px solid #ddd', borderRadius: 8, padding: 12 }, children: [_jsx("h3", { children: "All Categories" }), categories.length === 0 ? (_jsx("p", { children: "No table categories yet." })) : (_jsx("div", { style: { display: 'grid', gap: 12 }, children: categories.map((category) => (_jsx("div", { style: {
                                ...
                                alignItems: 'center'
                            }, children: editingId === category.id ? (_jsxs("div", { style: { flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr 1fr auto', gap: 8, alignItems: 'end' }, children: [_jsxs("label", { style: { display: 'grid', gap: 4 }, children: ["Name", _jsx("input", { value: editName, onChange: (e) => setEditName(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: ["Capacity", _jsx("input", { type: "number", min: 1, max: 1000, value: editSeatingCapacityText, onChange: (e) => setEditSeatingCapacityText(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: ["Meal Package", _jsx("input", { value: editMealPackage, onChange: (e) => setEditMealPackage(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: ["Rate ($)", _jsx("input", { value: editRatePerPersonText, onChange: (e) => setEditRatePerPersonText(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: ["Description", _jsx("input", { value: editDescription, onChange: (e) => setEditDescription(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: ["Photo URL", _jsx("input", { value: editPhotoUrl, onChange: (e) => setEditPhotoUrl(e.target.value), placeholder: "https://example.com/image.jpg" })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: ["Active", _jsx("input", { type: "checkbox", checked: editIsActive, onChange: (e) => setEditIsActive(e.target.checked) })] }), _jsxs("div", { style: { display: 'flex', gap: 4 }, children: [_jsx("button", { onClick: saveEdit, disabled: !canSaveEdit, style: { background: '#007bff', color: 'white', padding: '4px 8px', border: 'none', borderRadius: 4 }, children: updateMutation.isPending ? 'Saving...' : 'Save' }), _jsx("button", { onClick: cancelEdit, style: { background: '#6c757d', color: 'white', padding: '4px 8px', border: 'none', borderRadius: 4 }, children: "Cancel" })] }), editValidation.errors.length > 0 && (_jsx("div", { style: { gridColumn: '1 / -1', color: '#b00020', fontSize: '0.9em' }, children: editValidation.errors[0] }))] })) : (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: 'flex', gap: 8, alignItems: 'center' }, children: [category.photoUrl ? (_jsx("img", { src: category.photoUrl, alt: category.name, style: { width: 80, height: 60, objectFit: 'cover', borderRadius: 4 } })) : null, _jsxs("div", { children: [_jsx("strong", { children: category.name }), _jsxs("p", { style: { margin: '4px 0 0', fontSize: '0.9em', color: '#666' }, children: ["Capacity: ", category.seatingCapacity, ", Meal: ", category.mealPackage, ", Rate: $", (category.ratePerPerson / 100).toFixed(2), category.description ? ` - ${category.description}` : '', !category.isActive && ' (Inactive)'] })] })] }), _jsxs("div", { style: { display: 'flex', gap: 4 }, children: [_jsx("button", { onClick: () => startEditing(category), style: { background: '#28a745', color: 'white', padding: '4px 8px', border: 'none', borderRadius: 4 }, children: "Edit" }), _jsx("button", { onClick: () => deleteMutation.mutate(category.id), disabled: deleteMutation.isPending, style: { background: '#b00020', color: 'white', padding: '4px 8px', border: 'none', borderRadius: 4 }, children: "Delete" })] })] })) }, category.id))) }))] }))] }));
};
