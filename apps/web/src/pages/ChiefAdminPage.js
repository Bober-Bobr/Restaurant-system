    ...
    return (_jsxs("div", { className: "adm-bg", style: { fontFamily: 'Inter, system-ui, sans-serif' }, children: [_jsxs("header", { className: "tablet-fade-in", style: {
                    ...
                    borderBottom: '1px solid rgba(255,255,255,0.08)',
                        ...
                        transition: 'all 0.18s',
                                                            ...
                                                            }, children: "Edit credentials" }), u.role !== 'CHIEF_ADMIN' && (_jsx("button", { onClick: () => { if (confirm(`Delete user ${u.username}?`))
                                                                deleteUser.mutate(u.id); }, style: { ...btnStyle, background: '#dc2626' }, children: "Delete" }))] }), editingUserId === u.id && (_jsx(EditCredentialsForm, { userId: u.id, currentUsername: u.username, onClose: () => setEditingUserId(null), invalidateKeys: [['cad-users']], locale: "en" }))] }, u.id))) })] })] }))] })] }));
};
const inputStyle = {
