...
export const AdminHallsPage = () => {
    ...
    return (_jsxs("main", { style: { padding: 20 }, children: [_jsx("h1", { children: t('halls_management') }), _jsxs("section", { style: { border: '1px solid #ddd', borderRadius: 8, padding: 12, marginBottom: 16 }, children: [_jsx("h3", { children: t('create_hall') }), _jsxs("form", { onSubmit: (event) => {
                            ...
                            createMutation.mutate();
                                ...
                                alignItems: 'center'
                            }, children: editingId === hall.id ? (_jsxs("div", { style: { flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr 1fr auto', gap: 8, alignItems: 'end' }, children: [_jsxs("label", { style: { display: 'grid', gap: 4 }, children: [t('name'), _jsx(Input, { value: editName, onChange: (e) => setEditName(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: [t('hall_capacity'), _jsx(Input, { type: "number", min: 1, max: 5000, value: editCapacityText, onChange: (e) => setEditCapacityText(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: [t('hall_description'), _jsx(Input, { value: editDescription, onChange: (e) => setEditDescription(e.target.value) })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: [t('hall_photo_url'), _jsx(Input, { value: editPhotoUrl, onChange: (e) => setEditPhotoUrl(e.target.value), placeholder: t('photo_url_placeholder') })] }), _jsxs("label", { style: { display: 'grid', gap: 4 }, children: [t('hall_active'), _jsx("input", { type: "checkbox", checked: editIsActive, onChange: (e) => setEditIsActive(e.target.checked) })] }), _jsxs("div", { style: { display: 'flex', gap: 4 }, children: [_jsx(Button, { onClick: saveEdit, disabled: !canSaveEdit, children: updateMutation.isPending ? t('saving') : t('save') }), _jsx(Button, { variant: "secondary", onClick: cancelEdit, children: t('cancel') })] }), editValidation.errors.length > 0 && (_jsx("div", { style: { gridColumn: '1 / -1', color: '#b00020', fontSize: '0.9em' }, children: editValidation.errors[0] }))] })) : (_jsxs(_Fragment, { children: [_jsxs("div", { style: { display: 'flex', gap: 8, alignItems: 'center' }, children: [hall.photoUrl ? (_jsx("img", { src: hall.photoUrl, alt: hall.name, style: { width: 80, height: 60, objectFit: 'cover', borderRadius: 4 } })) : null, _jsxs("div", { children: [_jsx("strong", { children: hall.name }), _jsxs("p", { style: { margin: '4px 0 0', fontSize: '0.9em', color: '#666' }, children: [t('hall_capacity'), ": ", hall.capacity, hall.description ? ` - ${hall.description}` : '', !hall.isActive && ` (${t('hall_inactive')})`] })] })] }), _jsxs("div", { style: { display: 'flex', gap: 4 }, children: [_jsx("button", { onClick: () => startEditing(hall), style: { background: '#28a745', color: 'white', padding: '4px 8px', border: 'none', borderRadius: 4 }, children: t('edit') }), _jsx("button", { onClick: () => deleteMutation.mutate(hall.id), disabled: deleteMutation.isPending, style: { background: '#b00020', color: 'white', padding: '4px 8px', border: 'none', borderRadius: 4 }, children: t('delete') })] })] })) }, hall.id))) }))] }))] }));
};
