...
export const AdminRestaurantsPage = () => {
    ...
    return (_jsxs("main", { style: { maxWidth: 860, margin: '0 auto', padding: '24px 16px' }, children: [_jsx("h1", { style: { fontSize: 22, fontWeight: 700, marginBottom: 24 }, children: t('restaurants_management') }), _jsxs("section", { style: { background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: 8, padding: 20, marginBottom: 32 }, children: [_jsx("h2", { style: { fontSize: 16, fontWeight: 600, marginBottom: 16 }, children: t('create_restaurant') }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }, children: [_jsxs("label", { style: labelStyle, children: [_jsxs("span", { style: labelTextStyle, children: [t('restaurant_name'), " *"] }), _jsx("input", { value: name, onChange: (e) => setName(e.target.value), placeholder: t('restaurant_name_placeholder'), style: inputStyle })] }), _jsxs("label", { style: labelStyle, children: [_jsx("span", { style: labelTextStyle, children: t('restaurant_address') }), _jsx("input", { value: address, onChange: (e) => setAddress(e.target.value), placeholder: t('restaurant_address_placeholder'), style: inputStyle })] }), _jsxs("label", { style: { ...labelStyle, gridColumn: '1 / -1' }, children: [_jsx("span", { style: labelTextStyle, children: t('restaurant_logo_url') }), _jsx("input", { value: logoUrl, onChange: (e) => setLogoUrl(e.target.value), placeholder: "https://example.com/logo.png", style: inputStyle })] })] }), _jsxs("div", { style: { marginTop: 12, display: 'flex', gap: 12, alignItems: 'center' }, children: [_jsx("button", { onClick: () => { setFormError(null); createMutation.mutate(); }, disabled: createMutation.isPending || !name.trim(), style: {
                                    padding: '8px 20px',
