...
export const OwnerCabinetPage = () => {
    ...
    return (_jsxs("div", { className: "adm-bg", style: { fontFamily: 'Inter, system-ui, sans-serif' }, children: [_jsxs("header", { className: "tablet-fade-in", style: {
                    ...
                    flexWrap: 'wrap', gap: 12,
                                    ...
                                    }, children: LOCALE_LABELS[loc] }, loc))) }), _jsxs("button", { onClick: handleLogout, className: "adm-btn-danger", style: { display: 'inline-flex', alignItems: 'center', gap: 6 }, children: [_jsxs("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("path", { d: "M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" }), _jsx("polyline", { points: "16 17 21 12 16 7" }), _jsx("line", { x1: "21", y1: "12", x2: "9", y2: "12" })] }), t('logout')] })] })] }), _jsxs("nav", { style: { display: 'flex', gap: 4, padding: '0 24px', borderBottom: '1px solid rgba(255,255,255,0.06)', background: 'rgba(15,23,42,0.5)' }, children: [_jsx("button", { onClick: () => setTab('companies'), style: tabStyle(tab === 'companies'), children: t('companies') }), _jsx("button", { onClick: () => setTab('users'), style: tabStyle(tab === 'users'), children: t('users') })] }), _jsxs("main", { className: "tablet-fade-in", style: { maxWidth: 1180, margin: '0 auto', padding: '28px 24px', position: 'relative', zIndex: 1 }, children: [tab === 'companies' && (_jsxs(_Fragment, { children: [_jsxs("section", { className: "adm-card tablet-fade-up adm-section", style: { marginBottom: 24 }, children: [_jsx("h2", { className: "adm-heading", style: { marginTop: 0, marginBottom: 16 }, children: t('new_company') }), _jsxs("div", { style: { display: 'grid', gap: 12, gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }, children: [_jsx("input", { placeholder: t('company_name'), value: newName, onChange: (e) => setNewName(e.target.value), style: inputStyle }), _jsx("input", { placeholder: t('logo_url_hint'), value: newLogo, onChange: (e) => setNewLogo(e.target.value), style: inputStyle })] }), newError && _jsx("p", { style: { color: '#f87171', marginTop: 8 }, children: newError }), _jsx("button", { onClick: () => createCompany.mutate(), disabled: !newName.trim() || createCompany.isPending, style: { ...btnStyle, marginTop: 12, opacity: !newName.trim() ? 0.5 : 1 }, children: createCompany.isPending ? t('creating') : t('create') })] }), companiesQuery.isLoading && _jsx("p", { style: { color: 'rgba(226,232,240,0.5)' }, children: "..." }), _jsxs("div", { style: { display: 'grid', gap: 16 }, children: [companies.map((company) => {
