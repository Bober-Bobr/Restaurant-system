...
function TableCategoryFullscreen({ tableCategories, onSelect, onLightbox, locale, setLocale, t, }) {
    ...
    return (_jsxs("div", { style: {
            ...
            display: 'flex', flexDirection: 'column',
                    ...
                    backdropFilter: 'blur(12px)',
                        ...
                        }, children: t('choose_table_category') }), _jsx("div", { style: { display: 'flex', gap: 4 }, children: locales.map((loc) => (_jsx("button", { type: "button", onClick: () => setLocale(loc), style: {
                                padding: '5px 12px',
                                borderRadius: 8,
                                border: '1px solid',
                            ...
                            }, children: loc }, loc))) })] }), _jsx("div", { ref: scrollRef, onScroll: handleScroll, className: "scrollbar-none", style: {
                    flex: 1, minHeight: 0,
                    display: 'flex',
                    overflowX: 'auto', overflowY: 'hidden',
                    scrollSnapType: 'x mandatory',
                    WebkitOverflowScrolling: 'touch',
                }, children: tableCategories.map((tc, i) => (_jsx(CategorySlide, { tc: tc, index: i + 1, total: tableCategories.length, onSelect: () => onSelect(tc.id), onLightbox: onLightbox, t: t }, tc.id))) }), _jsxs("div", { style: {
                    padding: '14px 20px',
                    ...
                    background: 'rgba(0,0,0,0.25)',
                    backdropFilter: 'blur(12px)',
                }, children: [_jsx("button", { type: "button", onClick: () => goTo(Math.max(0, currentIdx - 1)), disabled: currentIdx === 0, style: {
                            ...
                            transition: 'opacity 0.2s',
                        }, "aria-label": "Previous", children: "\u2039" }), _jsx("div", { style: { display: 'flex', gap: 8, alignItems: 'center' }, children: tableCategories.map((_, i) => (_jsx("button", { type: "button", onClick: () => goTo(i), style: {
                                ...
                                padding: 0,
                            }, "aria-label": `Go to slide ${i + 1}` }, i))) }), _jsx("button", { type: "button", onClick: () => goTo(Math.min(tableCategories.length - 1, currentIdx + 1)), disabled: currentIdx === tableCategories.length - 1, style: {
                            width: 44, height: 44, borderRadius: '50%',
                            border: '1px solid rgba(201,164,44,0.35)',
                            background: 'rgba(201,164,44,0.1)',
                            color: '#c9a42c', fontSize: 22, fontWeight: 700, lineHeight: 1,
...
function CategorySlide({ tc, index, total, onSelect, onLightbox, t, }) {
    ...
    return (_jsx("div", { style: {
            ...
            display: 'flex', flexDirection: 'column', alignItems: 'center',
                ...
                display: 'flex', flexDirection: 'column', gap: 18, alignItems: 'center',
                    ...
                    }, children: [index, " / ", total] }), _jsx("div", { style: {
                        ...
                        boxShadow: '0 14px 40px rgba(0,0,0,0.45)',
                    }, children: photos.length > 0 ? (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", onClick: () => onLightbox(getPhotoUrl(photos[photoIdx]) ?? ''), style: { display: 'block', width: '100%', height: '100%', border: 'none', padding: 0, background: 'transparent', cursor: 'zoom-in' }, children: _jsx("img", { src: getPhotoUrl(photos[photoIdx]), alt: tc.name, style: { width: '100%', height: '100%', objectFit: 'cover' }, className: "scale-in" }, photoIdx) }), photos.length > 1 && (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", onClick: photoPrev, style: {
                                            position: 'absolute', left: 10, top: '50%', transform: 'translateY(-50%)',
                                            width: 36, height: 36, borderRadius: '50%',
                                            background: 'rgba(0,0,0,0.55)', backdropFilter: 'blur(6px)',
                                            border: 'none', color: '#fff', fontSize: 20, lineHeight: 1, cursor: 'pointer',
                                        }, children: "\u2039" }), _jsx("button", { type: "button", onClick: photoNext, style: {
                                            ...
                                            display: 'flex', gap: 6,
                                        }, children: photos.map((_, i) => (_jsx("span", { style: {
                                                width: i === photoIdx ? 18 : 6, height: 6, borderRadius: 3,
                                                background: 'rgba(255,255,255,0.85)',
                                                opacity: i === photoIdx ? 1 : 0.5,
                                                transition: 'width 0.2s, opacity 0.2s',
                                            } }, i))) })] }))] })) : (_jsx("div", { style: { display: 'flex', height: '100%', alignItems: 'center', justifyContent: 'center' }, children: _jsx("svg", { width: "56", height: "56", viewBox: "0 0 24 24", fill: "none", stroke: "rgba(255,255,255,0.15)", strokeWidth: "1", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" }) }) })) }), _jsxs("div", { style: { textAlign: 'center' }, children: [_jsx("h2", { style: {
                                margin: 0, fontSize: 28, fontWeight: 700, color: '#fff', letterSpacing: '-0.01em',
                            }, children: tc.name }), _jsxs("p", { style: {
                                margin: '8px 0 0', fontSize: 18, fontWeight: 700, color: '#c9a42c',
                            }, children: [formatSum(tc.ratePerPerson), _jsxs("span", { style: { fontWeight: 400, color: 'rgba(255,255,255,0.55)', marginLeft: 6 }, children: ["/ ", t('person')] })] })] }), tc.description && (_jsx("p", { style: {
                        margin: 0, textAlign: 'center', maxWidth: 520,
                        fontSize: 14, lineHeight: 1.6, color: 'rgba(255,255,255,0.7)',
                    }, children: tc.description })), includedCats.length > 0 && (_jsx("div", { style: { display: 'flex', flexWrap: 'wrap', gap: 8, justifyContent: 'center' }, children: includedCats.map((cat) => (_jsx("span", { style: {
                            padding: '5px 12px', borderRadius: 999, fontSize: 12, fontWeight: 600,
                            background: 'rgba(201,164,44,0.15)', color: '#c9a42c',
                            border: '1px solid rgba(201,164,44,0.3)',
                        }, children: t(cat.toLowerCase()) }, cat))) })), _jsxs("button", { type: "button", onClick: onSelect, style: {
                        marginTop: 4,
                        padding: '14px 48px',
                        borderRadius: 14,
                        border: 'none',
...
export const TabletMenuPage = () => {
    ...
    return (_jsxs("main", { className: "rg-bg relative min-h-screen overflow-x-hidden px-4 py-6 sm:px-6 lg:px-8", children: [!welcomeShown && (_jsx("div", { style: {
                    position: 'fixed', inset: 0, zIndex: 9998,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    background: 'rgba(8,18,12,0.85)', backdropFilter: 'blur(10px)',
                    padding: '20px',
                }, children: _jsxs("div", { className: "tablet-fade-up", style: {
                        ...
                        textAlign: 'center',
                        color: '#fff',
                    }, children: [_jsx("div", { style: { display: 'flex', justifyContent: 'center', gap: 6, marginBottom: 20 }, children: locales.map((loc) => (_jsx("button", { type: "button", onClick: (e) => { e.stopPropagation(); setLocale(loc); }, style: {
                                    padding: '5px 12px',
                                    borderRadius: 8,
                                    border: '1px solid',
                                    borderColor: locale === loc ? 'rgba(201,164,44,0.6)' : 'rgba(255,255,255,0.15)',
                                    ...
                                    cursor: 'pointer',
                                    textTransform: 'uppercase',
                                }, children: loc }, loc))) }), restaurantLogoUrl && (_jsx("img", { src: getPhotoUrl(restaurantLogoUrl), alt: restaurantName ?? '', style: {
                                ...
                                color: '#c9a42c',
                            }, children: t('welcome_title', { restaurant: restaurantName ?? '' }) }), _jsxs("div", { style: { marginTop: 18, display: 'flex', flexDirection: 'column', gap: 12 }, children: [_jsx("p", { style: { margin: 0, fontSize: 15, lineHeight: 1.6, color: 'rgba(255,255,255,0.82)' }, children: t('welcome_intro') }), _jsx("p", { style: { margin: 0, fontSize: 15, lineHeight: 1.6, color: 'rgba(255,255,255,0.82)' }, children: t('welcome_help') }), _jsx("p", { style: { margin: 0, fontSize: 15, lineHeight: 1.6, fontWeight: 600, color: 'rgba(255,255,255,0.92)' }, children: t('welcome_bon_appetit') })] }), _jsxs("button", { type: "button", onClick: dismissWelcome, style: {
                                marginTop: 26,
                                padding: '12px 36px',
                                borderRadius: 14,
                                border: 'none',
                            ...
                            }, children: [t('welcome_continue'), " \u2192"] })] }) })), welcomeShown && !selectedTableCategoryId && !isLoading &&
                tableCategories.filter((tc) => tc.isActive).length > 0 && (_jsx(TableCategoryFullscreen, { tableCategories: tableCategories.filter((tc) => tc.isActive), onSelect: (id) => setTableCategory(id), onLightbox: setLightboxSrc, locale: locale, setLocale: setLocale, t: t })), _jsx(PageBackground, {}), lightboxSrc && _jsx(Lightbox, { src: lightboxSrc, onClose: () => setLightboxSrc(null) }), _jsxs("div", { className: "relative mx-auto max-w-7xl space-y-4 sm:space-y-6", children: [_jsx("header", { className: "tablet-fade-in overflow-hidden rounded-2xl sm:rounded-[28px] px-4 sm:px-8 py-4 sm:py-5 shadow-2xl", style: { background: 'rgba(0,0,0,0.35)', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(16px)' }, children: _jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4", children: [_jsxs("div", { className: "flex items-center gap-3 sm:gap-4 min-w-0", children: [restaurantLogoUrl && (_jsx("img", { src: getPhotoUrl(restaurantLogoUrl), alt: restaurantName ?? '', className: "h-10 sm:h-14", style: { width: 'auto', objectFit: 'contain', flexShrink: 0 } })), _jsxs("div", { className: "min-w-0", children: [restaurantName && _jsx("p", { className: "rg-label truncate", children: restaurantName }), _jsx("h1", { className: "text-base sm:text-2xl font-bold text-white truncate", children: t('client_menu_selection') })] })] }), _jsxs("div", { className: "flex items-center gap-2 sm:gap-3 flex-shrink-0", children: [_jsx("select", { value: locale, onChange: (e) => setLocale(e.target.value), className: "rg-input", style: { width: 'auto', paddingRight: '2rem', fontSize: '0.8rem' }, children: locales.map((l) => (_jsx("option", { value: l, children: t(l === 'en' ? 'english' : l === 'ru' ? 'russian' : 'uzbek') }, l))) }), _jsxs("button", { type: "button", onClick: () => navigate('/'), className: "inline-flex items-center gap-2 rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-medium transition-all whitespace-nowrap", style: { background: 'rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.8)', border: '1px solid rgba(255,255,255,0.15)' }, children: ["\u2190 ", t('events')] })] })] }) }), _jsxs("section", { className: "grid gap-6 lg:grid-cols-[1.35fr_0.65fr]", children: [_jsxs("div", { className: "space-y-6", children: [!viewOnly && (_jsxs("section", { className: "rg-card p-4 sm:p-6 tablet-fade-up", style: { animationDelay: '60ms' }, children: [_jsx("p", { className: "rg-heading", children: t('room_table_settings') }), _jsx("p", { className: "mt-1 mb-5 text-sm", style: { color: 'rgba(255,255,255,0.5)' }, children: t('choose_room_table_details') }), _jsxs("div", { className: "grid gap-4 lg:grid-cols-3", children: [[
