...
export const TabletMenuPage = () => {
    ...
    const sortedAndFiltered = quickSort((menuItems ?? []).filter((item) => activeCategory === null || item.category === activeCategory));
