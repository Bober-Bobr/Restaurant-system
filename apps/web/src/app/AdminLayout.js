...
export const AdminLayout = () => {
    ...
    return (_jsxs("div", { className: "adm-bg", children: [_jsx("nav", { style: {
                    ...
                    background: 'rgba(0,0,0,0.5)',
                        ...
                        overflowY: 'auto',
                    }, onClick: (e) => e.stopPropagation(), children: [navItems.map((item) => (_jsx(Link, { to: item.to, onClick: () => setMobileNavOpen(false), style: {
                                padding: '11px 16px',
                                borderRadius: 10,
                                fontSize: 14,
                                fontWeight: 600,
                            ...
                            }, children: item.label }, item.to))), _jsxs(Link, { to: `/tablet?restaurantId=${tabletRestaurantId}`, onClick: () => setMobileNavOpen(false), style: {
                                marginTop: 8,
                                padding: '11px 16px',
                                borderRadius: 10,
                                fontSize: 14,
                            ...
                            }, children: [_jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("rect", { x: "3", y: "4", width: "18", height: "14", rx: "2" }), _jsx("line", { x1: "8", y1: "20", x2: "16", y2: "20" }), _jsx("line", { x1: "12", y1: "18", x2: "12", y2: "20" })] }), t('tablet')] }), _jsxs("div", { style: { marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: 10, paddingTop: 16, borderTop: '1px solid rgba(255,255,255,0.08)' }, children: [_jsx("div", { style: { display: 'flex', gap: 6 }, children: locales.map((loc) => (_jsx("button", { type: "button", onClick: () => setLocale(loc), style: {
                                            flex: 1,
                                            padding: '7px 10px',
                                            border: '1px solid',
                                            borderColor: locale === loc ? 'rgba(201,164,44,0.5)' : 'rgba(255,255,255,0.1)',
