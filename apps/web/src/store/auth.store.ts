...
export type AdminRole = 'CHIEF_ADMIN' | 'MANAGER' | 'OWNER' | 'ADMIN' | 'CATERING_ADMIN' | 'RESTAURANT_MANAGER' | 'EMPLOYEE' | 'KITCHEN' | 'NFC_MAKER' | 'PERFORMER' | 'HOST' | 'CATERING_EMPLOYEE' | 'SUPERVISOR';
