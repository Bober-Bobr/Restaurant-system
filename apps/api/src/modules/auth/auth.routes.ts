...
router.get('/users', adminAuthMiddleware, requireRole(AdminRole.CHIEF_ADMIN, AdminRole.MANAGER, AdminRole.OWNER, AdminRole.ADMIN, AdminRole.CATERING_ADMIN, AdminRole.RESTAURANT_MANAGER), controller.listUsers.bind(controller));
...
router.patch('/users/:id/restaurant', adminAuthMiddleware, requireRole(AdminRole.CHIEF_ADMIN), controller.updateRestaurant.bind(controller));
...
router.post('/users', adminAuthMiddleware, requireRole(AdminRole.CHIEF_ADMIN, AdminRole.MANAGER, AdminRole.OWNER, AdminRole.ADMIN, AdminRole.CATERING_ADMIN, AdminRole.RESTAURANT_MANAGER), controller.createUserAsChief.bind(controller));
