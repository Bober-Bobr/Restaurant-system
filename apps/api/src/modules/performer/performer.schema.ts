...
export const performerEventSchema = z.object({
  ...
  // Hosts run to a programme; performers leave this empty.
  program: z.string().max(8000).optional().nullable(),
});
...
// `program` is optional here and required in the service when the person being
// booked is a host: the requirement depends on the target's role, which this
// schema cannot see.
